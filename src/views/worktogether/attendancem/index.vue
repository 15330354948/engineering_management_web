  ...
  <div class="mtask-container">
      ...
      <div class="search-panel">
        ...
        >
          ...
          <el-form-item prop="deviceType">
            <el-select clearable v-model="mtaskForm.gender" placeholder="请选择性别">
              <el-option label="项目一" value="shanghai"></el-option>
              <el-option label="项目二" value="beijing"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item prop="deviceType">
            <el-select clearable v-model="mtaskForm.jobTitl" placeholder="请选择职务">
              <el-option label="项目一" value="shanghai"></el-option>
              <el-option label="项目二" value="beijing"></el-option>
            </el-select>
          </el-form-item>
   ...
   <div class="table-panel">
      ...
      >
        ...
        <el-table-column prop="name" label="职务" width="120">
        </el-table-column>
        <el-table-column prop="name" label="所属单位" width="420">
        </el-table-column>
        <el-table-column prop="name" label="考勤位置" width="420">
        </el-table-column>
        <el-table-column prop="name" label="考勤时间" width="200">
        </el-table-column>
