            ...
            <div class="right-content">
              ...
              <el-form class="config-form" ref="configForm" :model="configForm" :rules="configRules" label-width="120px">
                ...
                <el-form-item label="工序类型" prop="type">
                  <el-select v-model="configForm.type" placeholder="请选择工序类型类型" clearable>
                    <el-option
                ...
                <el-form-item label="参与审核权限" prop="status">
                  <el-select ref="configForm" v-model="configForm.status" :multiple="true" placeholder="请选择参与审核权限" clearable>
                    <el-option
                      v-for="dict in statusOptions"
                      :key="dict.dictValue"
                      :label="dict.dictLabel"
...
<script>
import { addAssessment, updateAssessment } from "@/api/projects/assessment";
